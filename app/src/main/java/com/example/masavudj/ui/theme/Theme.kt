package com.example.masavudj.ui.theme
...
private val DarkColorScheme = darkColorScheme(
    ...
    surface = DjPanelBg,
    surfaceVariant = DjPanelSurface,
    onPrimary = DjDarkChassis,
    onSecondary = DjDarkChassis,
    onBackground = androidx.compose.ui.graphics.Color(0xFFE6EDF3),
    onSurface = androidx.compose.ui.graphics.Color(0xFFE6EDF3)
)

@Composable
fun MasavuDjTheme(content: @Composable () -> Unit) {
